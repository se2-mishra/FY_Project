...
// import WeaveHash_abi from "./WeaveHash.json";
import WeaveHash from "./WeaveHash_abi.json";
// import Inheritance_abi from "./Inheritance.json";
import Inheritance from "./Inheritance_abi.json";
...
const HASH_CONTRACT_ADDRESS = "0x3507fd9b47897098239c5686C494bE3D597c6949";
...
class Reader extends Component {
    ...
    async readClaim() {
        ...
        console.log(res)
        window.alert("ITEM 1 : Setu Mishra, son, with last 4 Aadhar digit 2553, 15 Houses on Mars; ITEM 2 :Vratik Zade, son, with last 4 Aadhar digits 5678, Fiat USD; ITEM 3: Akshay Dhobale, nephew, with last 4 Aadhar digits 4567, Fiat USD; ITEM 4: Mayuri Kamdi, niece, with last 4 Aadhar digits 7654, Fiat USD");
    ...
    async check() {
        ...
        try {
            ...
            success = false;
            this.setState({
                error: "Signature  verification Passed",
            });
        }
                    ...
                    <div class="max-w-2xl p-6 mx-auto text-center backdrop-sepia-0 backdrop-blur-sm">
                        ...
                        <p class="transition ">
                            ...
                            <button
                                ...
                                className="px-5 py-2.5 mx-2 mt-8 text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700 rounded-md shadow"
