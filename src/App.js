            ...
            <div className="fixed w-1/4 h-full flex flex-col justify-between">
                ...
                <div className='max-h-2/5 flex flex-col justify-end items-center'>
                    ...
                    <div className='justify-center flex-nowrap flex items-center'>
                        ...
                        <a href={"https://etherscan.io/address/0xbEAa04819C149a7208b54afa885e05df23b47E46"} className="text-xs font-light underline hover:text-indigo-300 hover:ease-in-out hover:transition hover:duration-700">Writing Hashes of the Will</a>
                        <a href={"https://etherscan.io/address/0xbEAa04819C149a7208b54afa885e05df23b47E46#events"} className="text-xs font-light underline hover:text-indigo-300 hover:ease-in-out hover:transition hover:duration-700">Oracle Signing</a>
                    </div>
                    ...
                    <div className='flex flex-nowrap items-center pb-6'>
                        ...
                        <span className='text-white font-light text-m'>Made With</span>
